...
public class WayBills {
    ...
    private static final String REQ_URL = "https://bsp-oisp.sf-express.com/bsp-oisp/sfexpressService";
    ...
    private static String getWayBillXml(String trackingNumber) {
       String myReqXML = getReqXml(CLIENT_CODE,trackingNumber);
      return client.callSfExpressServiceByCSIM(REQ_URL, myReqXML, CLIENT_CODE, CHECK_WORD);
    }
